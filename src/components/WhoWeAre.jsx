...
function WhoWeAre() {
  return (
    <section
      id="who-we-are"
      className="relative flex min-h-[88vh] items-center overflow-hidden bg-gradient-to-br from-[#f1f4ee] via-[#eaeee7] to-[#e3e8df] py-16 md:py-20"
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute left-6 top-10 z-0 h-[200px] w-[200px] rounded-full bg-[#dde6d8]/34 blur-3xl sm:left-10 sm:h-[240px] sm:w-[240px] md:h-[300px] md:w-[300px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-8 top-1/2 z-0 h-[230px] w-[230px] -translate-y-1/2 rounded-full bg-[#d3dfcd]/30 blur-3xl sm:right-14 sm:h-[280px] sm:w-[280px] md:right-20 md:h-[350px] md:w-[350px]"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute right-0 top-0 z-0 h-full w-full object-cover object-center opacity-[0.14] grayscale mix-blend-multiply md:w-[50vw] md:min-w-[220px] md:max-w-[620px] md:object-left"
      />
      ...
      <div className="container relative z-20">
        ...
        >
          <Motion.h2 className="mt-1 text-5xl font-extrabold tracking-tight text-[#1f1a17] sm:text-6xl">
            Who We Are
          </Motion.h2>
